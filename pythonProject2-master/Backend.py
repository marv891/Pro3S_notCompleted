...
class GUI_functions():
    ...
    def getActualTime(self):
        try:
            ...
            self.ErrorOut.setText("Error: Failed to load current date and time. Backend, function in line: " + frameinfo.lineno)
    ...
    def update(self):
         ...
         try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Camera disconnected. First: Check connection to camera. Second: Restart program/timer. Backend, function in line: " + frameinfo.lineno)
            if self.retryCnt >= 5:
    ...
    def retryErrorUiClicked(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to restart Timer and/or failed to close warning window. Close all windows and restart program. Backend, function in line: " + frameinfo.lineno)
    ...
    def manualchange(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to change manual. Try again. Backend, function in line: " + frameinfo.lineno)
    ...
    def autoexptime(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to set exposure time parameters for automatic mode. Backend, function in line: " + frameinfo.lineno)
    ...
    def setexptime(self):
        ...
        if not self.Auto.isChecked():
            try:
                ...
                print(type(e))
                traceback.print_exc()
                self.ErrorOut.setText(self.getActualTime() + "Error: Failed to set exposure time in manual mode. Backend, function in line: " + frameinfo.lineno)
            return
    ...
    def getexptime(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to get exposure time and to set gain value. Backend, function in line: " + frameinfo.lineno)
    ...
    def autogain(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to set gain parameters for automatic mode. Backend, function in line: " + frameinfo.lineno)
    ...
    def setgain(self):
        ...
        if not self.Auto.isChecked():
            try:
                ...
                print(type(e))
                traceback.print_exc()
                self.ErrorOut.setText(self.getActualTime() + "Error: Failed to set gain parameters in manual mode. Backend, function in line: " + frameinfo.lineno)
            return
    ...
    def getgain(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to get gain value. Backend, function in line: " + frameinfo.lineno)
    ...
    def setbrightness(self):
        ...
        if self.Auto.isChecked():
            try:
                ...
                print(type(e))
                traceback.print_exc()
                self.ErrorOut.setText(self.getActualTime() + "Error: Failed to set brightness value. Backend, function in line: " + frameinfo.lineno)
            return
    ...
    def flashing(self):
        ...
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Flashing 'Frames/s' failed. Backend, function in line: " + frameinfo.lineno)
    ...
    def Captureimage(self):
        try:
            ...
            print(type(e))
            traceback.print_exc()
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to save image. Backend, function in line: " + frameinfo.lineno)
        return
    ...
    def openimage(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to open image. Backend, function in line: " + frameinfo.lineno)
    ...
    def openParameterDialog(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to open file explorer or/and to get filepath. Backend, function in line: " + frameinfo.lineno)
        # Set Parameters of camera
        try:
            frameinfo = getframeinfo(currentframe())
            CameraControl.readSettingsOutOfFile(opendialogpath)
        except:
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to load custom parameters. Backend, function in line: " + frameinfo.lineno)
        try:
            frameinfo = getframeinfo(currentframe())
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to set GUI-parameters. Backend, function in line: " + frameinfo.lineno)
        return (0)
    ...
    def saveCustomParametersInFile(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to open filename-ui. Backend, function in line: " + frameinfo.lineno)
    ...
    def clickedSaveButton(self):
        ...
        try:  
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to save custom parameters. Backend, function in line: " + frameinfo.lineno)
    ...
    def readDefaultParametersOutOfFile(self):
        ...
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to initialise default parameters. Check if 'Default' file exists. Backend, function in line: " + frameinfo.lineno)
        try:
            frameinfo = getframeinfo(currentframe())
            # Setting the right values into the interface by checking the camera
            self.Exposure_Box.setValue(CameraControl.getval("ExposureTime"))
...
# =============================================================================
#     def readCustomParametersOutOfFile(self):
#         CameraControl.readSettingsOutOfFile()
#         
#         # Setting the right values into the interface by checking the camera
#         self.Exposure_Box.setValue(CameraControl.getval("ExposureTime"))
#         self.Exposure_Time.setValue(CameraControl.getval("ExposureTime"))
...
# =============================================================================
    ...
    def rasptime(self):
        try:
            ...
            print("Current Time =", current_time) #notwendig???
            self.Timedisplay.setText(current_time)
        except:
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to set get and/or set time. Backend, function in line: " + frameinfo.lineno)
    ...
    def readoffset(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to read offset. Backend, function in line: " + frameinfo.lineno)
    ...
    def autoguigenerate(self):
        try:
            ...
            print(type(e))
            traceback.print_exc()
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to set up GUI-parameters. Backend, function in line: " + frameinfo.lineno)
    ...
    def featureenumset(self):
        try:
            ...
            print(type(e))
            traceback.print_exc()
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to set enum-feature. Backend, function in line: " + frameinfo.lineno)
    ...
    def featureboolset(self):
        try:
            ...
            print(type(e))
            traceback.print_exc()
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to set bool-feature. Backend, function in line: " + frameinfo.lineno)
    ...
    def featurefloatset(self):
        try:
            ...
            print(type(e))
            traceback.print_exc()
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to set float-feature. Backend, function in line: " + frameinfo.lineno)
    ...
    def Description(self, featurename):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to get description of feature. Description may not be available. Backend, function in line: " + frameinfo.lineno)
    ...
    def openlog(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to open login window. Backend, function in line: " + frameinfo.lineno)
    ...
    def coordinates(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Coordinates-function failed. Backend, function in line: " + frameinfo.lineno)
    ...
    def zoom_in(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to zoom in. Backend, function in line: " + frameinfo.lineno)
    ...
    def zoom_out(self):
        try:
            ...
            self.ErrorOut.setText(self.getActualTime() + "Error: Failed to zoom out. Backend, function in line: " + frameinfo.lineno)