...
# Form implementation generated from reading ui file 'C:\Users\TomatoTech\Downloads\Endversionen_GUI\GUI_V3.ui'
#
...
class Ui_MainWindow(GUI_functions):
    def __init__(self):
        ...
        self.VideoStream.setMinimumSize(QtCore.QSize(640, 512))
        self.VideoStream.setMaximumSize(QtCore.QSize(1280, 1024))
        self.VideoStream.setSizeIncrement(QtCore.QSize(5, 4))
        self.VideoStream.setBaseSize(QtCore.QSize(600, 400))
        self.VideoStream.setCursor(QtGui.QCursor(QtCore.Qt.CrossCursor))
        self.VideoStream.setMouseTracking(True)
        self.VideoStream.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.VideoStream.setPixmap(QtGui.QPixmap("20220113_000_Anwesend_2"))
        self.VideoStream.setScaledContents(True)
        self.VideoStream.setAlignment(QtCore.Qt.AlignJustify|QtCore.Qt.AlignTop)
        self.VideoStream.setObjectName("VideoStream")
        self.gridLayout_2.addWidget(self.VideoStream, 0, 0, 1, 1)
        self.CoordinatesDisplay = QtWidgets.QLabel(self.groupBox)
        self.CoordinatesDisplay.setGeometry(QtCore.QRect(20, 630, 171, 161))
        ...
        self.Snapshot.setMaximumSize(QtCore.QSize(150, 25))
        ...
        self.ZoomOutButton.setMinimumSize(QtCore.QSize(25, 25))
        ...
        self.zoomSlider.setMinimumSize(QtCore.QSize(150, 0))
        self.zoomSlider.setMaximumSize(QtCore.QSize(150, 16777215))
        ...
        self.ZoomInButton.setMinimumSize(QtCore.QSize(25, 25))
        ...
        self.Frames.setMinimumSize(QtCore.QSize(20, 20))
        self.Frames.setMaximumSize(QtCore.QSize(16777215, 50))
        ...
        self.parameter_Box.setMinimumSize(QtCore.QSize(100, 561))
        self.parameter_Box.setMaximumSize(QtCore.QSize(267, 1200))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(0, 10, 261, 425))
        ...
        self.Exposure_Time.setMaximumSize(QtCore.QSize(16777215, 10))
        ...
        self.Gain.setMaximumSize(QtCore.QSize(16777215, 10))
        self.Gain.setMaximum(8)
        ...
        self.TargetBrightnessslider.setMaximumSize(QtCore.QSize(16777215, 10))
        ...
        self.verticalLayout_15.addWidget(self.parameter_Box)
        ...
        self.label_3.setMaximumSize(QtCore.QSize(267, 20))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ErrorOut.sizePolicy().hasHeightForWidth())
        self.ErrorOut.setSizePolicy(sizePolicy)
        self.ErrorOut.setMinimumSize(QtCore.QSize(267, 50))
        self.ErrorOut.setMaximumSize(QtCore.QSize(267, 50))
        self.ErrorOut.setObjectName("ErrorOut")
        self.verticalLayout_15.addWidget(self.ErrorOut)
        self.gridLayout.addLayout(self.verticalLayout_15, 0, 0, 4, 1)
        ...
        self.gridLayout.addWidget(self.horizontalScrollBar, 2, 1, 1, 1)
        ...
        self.actionLoadCustom = QtWidgets.QAction(MainWindow)
        self.actionLoadCustom.setObjectName("actionLoadCustom")
        ...
        self.menuInit.addAction(self.actionLoadDefault)
        self.menuInit.addAction(self.actionLoadCustom)
        self.menuInit.addAction(self.actionSave_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ZoomOutButton.setStatusTip(_translate("MainWindow", "zooming into frame"))
        self.ZoomOutButton.setText(_translate("MainWindow", "-"))
        self.ZoomInButton.setStatusTip(_translate("MainWindow", "zoom out of frame"))
        ...
        self.actionLoadDefault.setText(_translate("MainWindow", "Load default"))
        self.actionLoadCustom.setText(_translate("MainWindow", "Load custom"))
        self.actionSave_2.setText(_translate("MainWindow", "Save"))


        # initilise the values of parameters
        self.readDefaultParametersOutOfFile()
